...
<div class="row" align="center">
	<div class="col-lg-12 col-md-12 mb-3">
		<a href="<?= base_url('tatausaha/tambahpengumuman'); ?>">
					...
					?>
						<tr>
							...
							<td class="text-center">
								...
								<a href="<?= base_url('/tatausaha/detailpengumuman/' . $det->id_pengumuman); ?>">
									<button class="btn btn-success btn-sm">
										<i class="fas fa-eye"></i> Detail
									</button>
								</a>
								&nbsp; &nbsp;
								<a href="<?= base_url('/tatausaha/ubahpengumuman/' . $det->id_pengumuman); ?>">
								...
								<a href="<?= base_url('/tatausaha/hapuspengumuman/' . $det->id_pengumuman); ?>">
