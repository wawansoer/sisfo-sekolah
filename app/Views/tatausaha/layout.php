    ...
    <div id="sidebar">
      <div class="sidebar-wrapper">
        ...
        <div class="sidebar-menu">
          <ul class="menu">
            <li class="sidebar-item <?= ($tatausaha == 1 ? "active" : ""); ?>">
              <a href="<?= base_url('tatausaha/'); ?>" class="sidebar-link">
                <i class="bi bi-grid-fill"></i>
                <span>Dashboard</span>
              </a>
            </li>

            <li class="sidebar-item <?= ($tatausaha == 2 ? "active" : ""); ?>">
              <a href="<?= base_url('tatausaha/guru'); ?>" class="sidebar-link">
                <i class="fas fa-chalkboard-teacher"></i>
                <span>Guru / Tendik</span>
              </a>
            </li>

            <li class="sidebar-item <?= ($tatausaha == 3 ? "active" : ""); ?>">
              <a href="<?= base_url('tatausaha/berkas'); ?>" class="sidebar-link">
            ...
            <li class="sidebar-item <?= ($tatausaha == 5 ? "active" : ""); ?>">
              <a href="<?= base_url('tatausaha/pengumuman'); ?>" class="sidebar-link">
