...
<div class="row">
	...
	<hr> 
	<form action="<?= base_url('adminWeb/prosesinputsambutan') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		<?= csrf_field(); ?>
		<div class="form-group row">
			<label class="col-md-2">Nama Kepala Sekolah</label>
			<div class="col-md-10">
				<input type="text" name="namakepsek" class="form-control" required>
			</div>
		</div>
