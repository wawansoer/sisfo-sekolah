    ...
    <div id="sidebar" >
      <div class="sidebar-wrapper">
        ...
        <div class="sidebar-menu">
          <ul class="menu">
            <li class="sidebar-item <?= ($kesiswaan == 1 ? "active" : ""); ?>">
              <a href="<?= base_url('kesiswaan/');?>" class="sidebar-link">
                <i class="bi bi-grid-fill"></i>
                <span>Dashboard</span>
              </a>
            </li>

            <li class="sidebar-item <?= ($kesiswaan == 2 ? "active" : ""); ?>">
              <a href="<?= base_url('kesiswaan/siswa');?>" class="sidebar-link">
                <i class="fas fa-user-graduate"></i>
                <span>Siswa</span>
              </a>
            </li>

            <li class="sidebar-item <?= ($kesiswaan == 3 ? "active" : ""); ?>">
              <a href="<?= base_url('kesiswaan/pengumuman');?>" class="sidebar-link">
