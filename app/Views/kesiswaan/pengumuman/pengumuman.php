...
<div class="row" align="center">
	<div class="col-lg-12 col-md-12 mb-3">
		<a href="<?= base_url('kesiswaan/tambahpengumuman');?>">
				...
				foreach ($pengumuman as $det) :
					...
					<tr>
						...
						<td class="text-center">
							...
							<a href="<?= base_url('/kesiswaan/detailpengumuman/'.$det->id_pengumuman); ?>">
								<button class="btn btn-success btn-sm">
									<i class="fas fa-eye"></i> Detail
								</button>
							</a>
							&nbsp; &nbsp;
							<a href="<?= base_url('/kesiswaan/ubahpengumuman/'.$det->id_pengumuman); ?>">
							...
							<a href="<?= base_url('/kesiswaan/hapuspengumuman/'.$det->id_pengumuman); ?>">
